...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header" style="padding: 2px;">
							...
							<div class="card">
								<div class="card-body">
									<form id="task-form">
										...
										<div class="form-group">
											<input type="text" id="escote" placeholder="Escote" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="escote_total" placeholder="Escote Total " 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="talle_delante" placeholder="Talle Delante" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="talle_atras" placeholder="Talle Atras" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="altura_busto" placeholder="Altura Busto" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="separacion_busto" placeholder="Separacion Busto" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="contorno_busto" placeholder="Contorno Busto" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="hombro_delante" placeholder="Hombro Delante" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="hombro_atras" placeholder="Hombro Atras" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="contorno_hombro" placeholder="Contorno Hombro" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="costado" placeholder="Costado" 
											class="form-control">
										...
										<div class="form-group">
											<input type="text" id="cintura_alta" placeholder="Cintura Alta" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="cintura_baja" placeholder="Cintura Baja" 
											class="form-control">
										...
										<div class="form-group">
											<input type="text" id="descaderado" placeholder="Descaderado" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="altura_cadera" placeholder="Altura Cadera" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="largo_falda" placeholder="Largo Falda" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="largo_manga" placeholder="Largo Manga" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="contorno_brazo" placeholder="Contorno Brazo" 
											class="form-control">
				
										</div>
										<div class="form-group">
											<input type="text" id="corte_imperio" placeholder="Corte Imperio" 
											class="form-control">
								...
								<table class="table table-bordered table-sm">
									<thead>
										...
										<td>Borrar</td>
											...
											<td>Talle Atras</td>
											<td>Altura Busto</td>
											<td>Separacion Busto</td>
											<td>Contorno Busto</td>
											<td>Hombro Delante</td>
											<td>Hombro Atras</td>
											<td>Contorno Hombro</td>
											<td>Costado</td>
											<td>Cintura</td>
											<td>Cintura_alta</td>
											<td>Cintura_baja</td>
