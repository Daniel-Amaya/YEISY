$(document).ready(function(){
	...
	$(".boton-menu span").click(function(e){
		e.preventDefault();
		if($(".boton-menu span").attr('class') == 'fas fa-bars'){
			$(".boton-menu span").removeClass('fas fa-bars').addClass('fas fa-times');
			$(".navegacion nav").animate({left:'0'})
		} else {
			$(".boton-menu span").removeClass('fas fa-times').addClass('fas fa-bars');
