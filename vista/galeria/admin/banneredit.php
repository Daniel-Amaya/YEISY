			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="../../../controlador/admin/medidas/medidasajax.php"><i class="zmdi zmdi-font zmdi-hc-fw"></i> Medidas</a>
						</li>
						<li>
							<a href="bannerlist.php"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Lista de ropa</a>
						</li>
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 200%;" >
